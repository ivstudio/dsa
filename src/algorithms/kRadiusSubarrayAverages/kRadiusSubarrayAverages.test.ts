...
describe('kRadiusSubarrayAverages', () => {
    it('should return correct averages for k = 1', () => {
    ...
    it('should return correct averages for k = 2', () => {
        const nums = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        const k = 2;
        const result = kRadiusSubarrayAverages(nums, k);
    ...
    it('should return all -1 for k larger than array length', () => {
        const nums = [1, 2, 3];
        const k = 5;
        const result = kRadiusSubarrayAverages(nums, k);
    ...
    it('should return correct averages for k = 0', () => {
